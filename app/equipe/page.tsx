          ...
          <>
            ...
            {selectedMatch && (
              <div className="flex items-center justify-between rounded-xl bg-green-50 border border-green-200 p-3">
                <div>
                  <div className="text-xs text-green-600 font-medium">Prochain match</div>
                  <div className="font-bold text-sm text-green-800">vs {selectedMatch.opponent}</div>
                </div>
                <div className="text-right">
                  <div className="text-xs text-green-600">{selectedMatch.match_date}</div>
                  <div className="text-xs font-bold text-green-700">Formation {selectedFormation}</div>
                </div>
              </div>
            )}
